...
namespace MVVM.ViewModels
{
    public class ReservationsListingViewModel : ViewModelBase
    {
        ...
        public ReservationsListingViewModel(HotelStore hotelStore, MakeReservationViewModel makeReservationViewModel, NavigationService makeReservationNavigationService)
        {
        ...
        public static ReservationsListingViewModel LoadViewModel(HotelStore hotelStore, MakeReservationViewModel makeReservationViewModel, NavigationService makeReservationNavigationService)
        {
            ReservationsListingViewModel viewModel = new ReservationsListingViewModel(hotelStore, makeReservationViewModel, makeReservationNavigationService);
